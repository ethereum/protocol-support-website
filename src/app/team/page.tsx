      ...
      <div className="relative z-10 max-w-[1100px] mx-auto page-container">
        ...
        <section className="section">
          ...
          <div className="flex flex-wrap gap-6" style={{ alignItems: "center" }}>
            <a href="https://github.com/ethereum/pm" target="_blank" rel="noopener noreferrer" className="link-blue" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "0.95rem" }}>
            ...
            <a href="https://discord.gg/a4gm9nT3Ty" target="_blank" rel="noopener noreferrer" className="link-blue" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "0.95rem" }}>
